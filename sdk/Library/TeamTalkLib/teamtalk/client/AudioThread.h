...
public:
    ...
    void SetMicrophoneEqualizer(const std::vector<float>& gains_db);
...
private:
    ...
    void ApplyMicrophoneEqualizer(media::AudioFrame& audblock);
    ...
    std::vector<float> m_mic_eq_gains_db;
    std::vector<std::vector<float>> m_mic_eq_state;
